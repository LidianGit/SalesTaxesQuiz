...
import com.lastminute.taxesquiz.tasklet.TaxesQuizTasklet;
...
@ContextConfiguration( classes = {TaxesTaskletConfig.class, BasketConfig.class, CheckoutConfig.class,
        FileReaderConfig.class, FormatterConfig.class, FileWriterConfig.class, ProductConfig.class, TaxConfig.class})
@Configuration
