package com.lastminute.taxesquiz.test.math.rounding.rule.strategy.impl;
...
public class NearestFiveRoundingRuleStrategyTest {

    @Test
    public void testRound(){
        RoundingRuleStrategy roundingRuleStrategy = new NearestFiveRoundingRuleStrategy();
        assertEquals( "0.00" , roundingRuleStrategy.round(new BigDecimal("0.00"), 2).toString() );
        assertEquals( "0.05" , roundingRuleStrategy.round(new BigDecimal("0.01"), 2).toString() );
        assertEquals( "0.05" , roundingRuleStrategy.round(new BigDecimal("0.02"), 2).toString() );
        assertEquals( "0.05" , roundingRuleStrategy.round(new BigDecimal("0.03"), 2).toString() );
        assertEquals( "0.05" , roundingRuleStrategy.round(new BigDecimal("0.04"), 2).toString() );
        assertEquals( "0.05" , roundingRuleStrategy.round(new BigDecimal("0.05"), 2).toString() );
        ...
        assertEquals( "0.15" , roundingRuleStrategy.round(new BigDecimal("0.11"), 2).toString() );
        assertEquals( "0.15" , roundingRuleStrategy.round(new BigDecimal("0.12"), 2).toString() );
        assertEquals( "0.15" , roundingRuleStrategy.round(new BigDecimal("0.13"), 2).toString() );
        assertEquals( "0.15" , roundingRuleStrategy.round(new BigDecimal("0.14"), 2).toString() );
        assertEquals( "0.15" , roundingRuleStrategy.round(new BigDecimal("0.15"), 2).toString() );
